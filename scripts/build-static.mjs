...
const STATIC_FILES = ['index.html', 'app.js', 'pdf-storage.js', 'library-logic.js', 'ui-logic.js', 'note-export.js', 'note-pdf-export.js', 'manifest.webmanifest', 'service-worker.js', 'icon.svg'];
