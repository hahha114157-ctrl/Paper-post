...
function paragraphXml(block = {}) {
  ...
  return `<w:p><w:pPr><w:pStyle w:val="${style}"/></w:pPr>${runs.map(runXml).join('')}</w:p>`;
}
...
export function buildNoteDocx({ title = '阅读笔记', metadata = [], blocks = [], images = [], exportedAt = new Date().toISOString() } = {}) {
  ...
  const body = [
    paragraphXml({ type: 'title', runs: [{ text: `${title} · 阅读笔记` }] }),
    ...metadata.filter(item => item?.value).map(item => paragraphXml({ runs: [{ text: `${item.label}：`, bold: true }, { text: String(item.value) }] })),
    paragraphXml({ runs: [{ text: `导出时间：`, bold: true }, { text: String(exportedAt) }] }),
    '<w:p><w:pPr><w:pBdr><w:bottom w:val="single" w:sz="6" w:space="1" w:color="DDE5DF"/></w:pBdr></w:pPr></w:p>',
    ...(blocks.length ? blocks.map(block => block.type === 'image'
      ? imageXml(images[block.imageIndex], imageRelationships[block.imageIndex].id, block.imageIndex)
      : paragraphXml(block)) : [paragraphXml({ runs: [{ text: '暂无阅读笔记', italic: true }] })]),
  ...
  const styles = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><w:styles xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main"><w:docDefaults><w:rPrDefault><w:rPr><w:rFonts w:ascii="Aptos" w:eastAsia="Microsoft YaHei" w:hAnsi="Aptos"/><w:sz w:val="22"/><w:lang w:val="zh-CN" w:eastAsia="zh-CN"/></w:rPr></w:rPrDefault><w:pPrDefault><w:pPr><w:spacing w:after="120" w:line="360" w:lineRule="auto"/></w:pPr></w:pPrDefault></w:docDefaults><w:style w:type="paragraph" w:default="1" w:styleId="Normal"><w:name w:val="Normal"/></w:style><w:style w:type="paragraph" w:styleId="Title"><w:name w:val="Title"/><w:basedOn w:val="Normal"/><w:rPr><w:b/><w:color w:val="116347"/><w:sz w:val="36"/></w:rPr></w:style><w:style w:type="paragraph" w:styleId="Heading2"><w:name w:val="Heading 2"/><w:basedOn w:val="Normal"/><w:rPr><w:b/><w:color w:val="116347"/><w:sz w:val="28"/></w:rPr></w:style><w:style w:type="paragraph" w:styleId="Quote"><w:name w:val="Quote"/><w:basedOn w:val="Normal"/><w:pPr><w:ind w:left="420"/><w:spacing w:before="120" w:after="120"/></w:pPr><w:rPr><w:i/><w:color w:val="59675F"/></w:rPr></w:style><w:style w:type="paragraph" w:styleId="Caption"><w:name w:val="Caption"/><w:basedOn w:val="Normal"/><w:rPr><w:i/><w:color w:val="6D7B73"/><w:sz w:val="18"/></w:rPr></w:style></w:styles>`;
